...
topic, a paper feed — is answered by the `paper-watch` skill, never from memory.**
The skill owns the arXiv fetch, the topic, and — most importantly — the **spine**:
it reads `progress.md` first to learn what was already shown, and writes it last.
